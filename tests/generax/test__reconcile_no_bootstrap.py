...
def test_reconcile_no_bootstrap(generax_data,tmpdir):
    ...
    supervisor.create_calc_dir("test0",
                               ...
                               tree=os.path.join(input_dir,"tree_wrong.newick"))
    ...
    expected_files = ["summary-tree.pdf","tree.newick","tree_events.newick","dataframe.csv"]
    ...
    output_T = ete3.Tree(os.path.join(supervisor.output_dir,"tree.newick"),format=0)
    input_T = ete3.Tree(os.path.join(supervisor.input_dir,"tree.newick"))

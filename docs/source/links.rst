...
.. _`toyplot-colors-link` : https://toyplot.readthedocs.io/en/stable/colors.html
.. _`toyplot-canvas-link` : https://toyplot.readthedocs.io/en/stable/canvas-layout.html
.. _`toyplot-css-link` : https://toyplot.readthedocs.io/en/stable/_modules/toyplot/style.html

.. _`css-wikipedia` : https://en.wikipedia.org/wiki/CSS
.. _`css-w3s` : https://www.w3schools.com/css/

.. _`blast-download` : https://ftp.ncbi.nlm.nih.gov/blast/executables/blast+/LATEST/

.. _`generax-link` : https://github.com/BenoitMorel/GeneRax

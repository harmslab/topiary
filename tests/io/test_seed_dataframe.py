...
from topiary.io.seed_dataframe import _get_string_variants, _get_alias_regex
from topiary.io.seed_dataframe import load_seed_dataframe
...
def test_load_seed_dataframe(seed_dataframes):
    ...
    def _validate_output(df, phylo_context, key_species, paralog_patterns):
        ...
        _arg_processors.process_topiary_dataframe(df)

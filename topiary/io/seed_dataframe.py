__description__ = \
"""
Functions for loading a seed dataframe.
"""
...
def load_seed_dataframe(df):
    ...
    This dataframe is expected to have at least four columns:
    ...
    Parameters
    ----------
        df: seed dataframe containing seed sequences to launch the analysis.
            df can be a pandas dataframe or a string pointing to a spreadsheet
            file.
    Return
    ------
        topiary dataframe, phylo_context, key_species, paralog_patterns
    """
